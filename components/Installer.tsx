...
import { MapPin, CheckCircle2, Clock, Navigation, Camera, ChevronRight } from 'lucide-react';
import { PrimaryButton, SecondaryButton, SideDrawer, Tabs } from './Shared';
            ...
            <div className="space-y-6">
               ...
               <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 border border-slate-200 dark:border-slate-700 rounded-xl bg-white dark:bg-slate-900">
                     ...
                     <button className="text-xs font-bold bg-slate-900 dark:bg-slate-800 text-white px-3 py-2 rounded-lg">Capture</button>
                  </div>
